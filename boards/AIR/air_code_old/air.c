...
#define SenseIMD
#define PIN_SenseIMD
#define SenseConnToHVD
#define PIN_SenseConnToHVD
#define SenseMainTSConn
#define PIN_SenseMainTSConn
...
/*----- Global Variables -----*/
volatile uint8_t gFlag = 0x01;  // Global Flag # use to limit how fast program is running
